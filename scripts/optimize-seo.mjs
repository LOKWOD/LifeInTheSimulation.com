...
const publicationDates = {
  ...
  ,"essays/preference-is-not-a-value.html": "2026-09-09"
  ,"guides/how-to-write-an-ai-decision-record.html": "2026-09-09"
  ,"guides/paper-shredders-strip-cross-micro-cut.html": "2026-09-09"
  ,"essays/counterfactual-is-not-an-alternate-reality.html": "2026-09-10"
  ,"guides/how-to-compare-two-ai-answers.html": "2026-09-10"
  ,"guides/home-wifi-router-vs-mesh-vs-access-points.html": "2026-09-10"
  ,"essays/dataset-is-not-the-world.html": "2026-09-11"
  ,"guides/how-to-run-a-premortem.html": "2026-09-11"
  ,"guides/ups-battery-backup-standby-line-interactive-online.html": "2026-09-11"
  ,"essays/observer-effect-does-not-mean-consciousness-creates-reality.html": "2026-09-13"
  ,"guides/how-to-build-an-ai-evidence-ledger.html": "2026-09-13"
  ,"guides/usb-c-hub-vs-thunderbolt-dock-vs-monitor-dock.html": "2026-09-13"
  ,"essays/forecast-is-not-a-future.html": "2026-09-15"
  ,"guides/how-to-audit-an-ai-workflow-before-automation.html": "2026-09-15"
  ,"guides/smart-home-hubs-matter-controller-thread-border-router-bridge.html": "2026-09-15"
  ,"essays/intelligence-is-not-consciousness.html": "2026-09-17"
  ,"guides/how-to-learn-ai-without-chasing-every-update.html": "2026-09-17"
  ,"guides/kvm-switch-vs-usb-switch-vs-dock.html": "2026-09-17"
...
const topicDefs = [
  { slug: "simulation-theory", name: "Simulation Theory & Reality", dek: "A grounded route through the simulation hypothesis, digital physics, evidence and the limits of computational metaphors.", links: ["essays/simulation-hypothesis-without-the-hype.html", "essays/what-would-count-as-evidence.html", "essays/digital-physics-and-information.html", "essays/dreams-are-not-evidence-of-simulation.html", "essays/predictive-processing-does-not-mean-reality-is-a-hallucination.html", "essays/self-model-is-not-a-fake-self.html", "essays/mind-upload-copy-personal-identity.html", "essays/counterfactual-is-not-an-alternate-reality.html", "essays/observer-effect-does-not-mean-consciousness-creates-reality.html", "guides/reality-audit.html"] },
  { slug: "ai-knowledge", name: "AI, Knowledge & Understanding", dek: "How to reason about model performance, automation, memory, explanation and the boundary between fluent output and justified knowledge.", links: ["essays/intelligence-is-not-consciousness.html", "guides/how-to-learn-ai-without-chasing-every-update.html", "essays/ai-accuracy-is-not-understanding.html", "essays/ai-and-the-end-of-knowing.html", "essays/the-feeling-of-understanding-is-not-understanding.html", "essays/automation-does-not-remove-responsibility.html", "essays/ai-explanation-is-not-the-mechanism.html", "essays/dataset-is-not-the-world.html", "essays/forecast-is-not-a-future.html", "guides/how-to-write-an-ai-decision-record.html", "guides/how-to-compare-two-ai-answers.html", "guides/how-to-build-an-ai-evidence-ledger.html", "guides/how-to-audit-an-ai-workflow-before-automation.html", "guides/ai-memory-controls-chatgpt-claude-gemini.html", "guides/local-ai-ollama-vs-lm-studio.html", "guides/best-books-to-understand-ai.html"] },
  { slug: "attention-agency", name: "Attention, Agency & Digital Life", dek: "Essays and practical protocols for understanding feeds, defaults, metrics and the systems competing to shape what you notice and choose.", links: ["essays/attention-economy-is-a-reality-engine.html", "essays/algorithmic-reality.html", "essays/the-default-is-a-decision-someone-else-made.html", "essays/preference-is-not-a-value.html", "essays/the-scoreboard-self.html", "guides/attention-reset.html", "guides/personal-algorithm-audit.html", "guides/website-blockers-for-focus.html", "guides/deep-work-field-manual.html", "guides/reversibility-test-for-decisions.html", "guides/stop-rule-decide-what-enough-means.html", "guides/how-to-run-a-premortem.html", "guides/how-to-run-a-one-person-experiment.html", "guides/e-readers-kindle-kobo-boox-library.html"] },
...
function topicFor(rel, category, title) {
  ...
  if (rel === "essays/counterfactual-is-not-an-alternate-reality.html") return topicDefs[0];
  if (rel === "guides/how-to-compare-two-ai-answers.html") return topicDefs[1];
  if (rel === "guides/home-wifi-router-vs-mesh-vs-access-points.html") return topicDefs[3];
  if (rel === "essays/dataset-is-not-the-world.html") return topicDefs[1];
  if (rel === "guides/how-to-run-a-premortem.html") return topicDefs[2];
  if (rel === "guides/ups-battery-backup-standby-line-interactive-online.html") return topicDefs[3];
  if (rel === "essays/observer-effect-does-not-mean-consciousness-creates-reality.html") return topicDefs[0];
  if (rel === "guides/how-to-build-an-ai-evidence-ledger.html") return topicDefs[1];
  if (rel === "guides/usb-c-hub-vs-thunderbolt-dock-vs-monitor-dock.html") return topicDefs[3];
  if (rel === "essays/forecast-is-not-a-future.html") return topicDefs[1];
  if (rel === "guides/how-to-audit-an-ai-workflow-before-automation.html") return topicDefs[1];
  if (rel === "guides/smart-home-hubs-matter-controller-thread-border-router-bridge.html") return topicDefs[3];
  if (rel === "essays/mind-upload-copy-personal-identity.html") return topicDefs[0];
  if (rel === "guides/stop-rule-decide-what-enough-means.html") return topicDefs[2];
  if (rel === "guides/home-networking-moca-vs-powerline-vs-mesh.html") return topicDefs[3];
