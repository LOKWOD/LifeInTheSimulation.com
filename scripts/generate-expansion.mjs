...
const pages = [
  ...
  },
  {
    ...
    sections: [
      ...
      ["Name the relationship facts", ["Who did you speak with? Who is waiting for a response? Where did you avoid a necessary conversation or fail to express appreciation?
", "Do not score relationships by message count. Look for attention, reliability, repair and shared time."]],
